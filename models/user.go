...
type User struct {
	...
	Name      string    `orm:"column(name);size(30);default('')" description:"用户名"`
	Email     string    `orm:"column(email);size(30);default('')" description:"邮箱"`
	Code      string    `orm:"column(code);size(10);default('')" description:"验证码"`
