...
func (m *Article_20220822_162618) Up() {
	...
	m.NewCol("tag").SetDataType("varchar(50)").SetDefault("''").SetNullable(false)
	m.NewCol("status").SetDataType("tinyint(3)").SetUnsigned(true).SetDefault("1").SetNullable(false)
	m.NewCol("is_top").SetDataType("tinyint(3)").SetUnsigned(true).SetDefault("0").SetNullable(false)
	m.NewCol("is_recommend").SetDataType("tinyint(3)").SetUnsigned(true).SetDefault("0").SetNullable(false)
